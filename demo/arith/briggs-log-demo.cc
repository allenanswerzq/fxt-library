...
//% Computation of the logarithm using a method similar to the shift-and-add
//algorithm.
...
void make_briggs_ltab(ulong na, double b) {
...
void print_xyza(long n, double x, double y, double z, double a) {
  cout << setw(2) << n;
...
double briggs_log(double x, double eps) {
  double y = 0;
  double z = x * 0.5;
