...
bool jcyc;
ulong pn;
ulong pfunc_parengray(const digraph_paths &dp)
// Function to be called with each path.
{
  ...
  //    if ( 0xaaaaaaaa & vn[rv[ng-1]] )  return 0;  // allow last=="()()()()"
  //    only
...
/// make-target2: "1demo DSRC=demo/graph/graph-parengray-demo.cc
