...
ulong pn;
bool jcyc;
ulong pfunc_fibrepgray(const digraph_paths &dp)
...
int main(int argc, char **argv) {
  ...
  pn = 1;
  while (fibonacci(pn) < n) ++pn;  // global, used in pfunc_fibrepgray()
...
/// make-target2: "1demo DSRC=demo/graph/graph-fibrepgray-demo.cc
