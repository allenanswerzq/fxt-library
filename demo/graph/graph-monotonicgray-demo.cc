...
//% Paths through a directed graph: all canonical monotonic Gray paths starting
//with zero.

//#define TIMING  // uncomment to disable printing

ulong pfunc_monotonic(const digraph_paths &dp)
...
ulong pfunc_all(const digraph_paths &dp)
// Function to be called with each path.
{
  const ulong *rv = dp.rv_;
  ulong ng = dp.ng_;
...
/// make-target2: "1demo DSRC=demo/graph/graph-monotonicgray-demo.cc
