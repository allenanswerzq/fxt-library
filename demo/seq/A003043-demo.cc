...
//% Number of Hamiltonian paths (or Gray codes) on n-cube with a marked starting
//node. % Computation as Permutations with restricted prefixes. % Also A059783:
//paths from vec(0) to vec(1).
...
int main(int argc, char **argv) {
  ...
  switch (c) {
    ...
    case 1:
      ...
      perm = new perm_prefix_cond(n, cond_gray_path, visit);
      break;
