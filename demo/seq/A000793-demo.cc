...
// Cf. comb/composition-nz-prefix-cond-demo.cc

//#define TIMING  // uncomment to disable printing

bool cond_all(const ulong *a, ulong k)
...
bool cond_no_2(const ulong *a, ulong k)
// ==> A213206
{
...
bool cond_no_n(const ulong *a, ulong k) {
...
//  echo $(for n in $(seq 1 20); do ./bin $n 0; done | grep r= ) | sed 's/ r=/,
//  /g;'
