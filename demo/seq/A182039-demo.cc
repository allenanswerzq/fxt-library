...
for n in $(seq 1000); do; ./bin $n; done  3915.17s user 1.63s system 99% cpu
1:05:18.20 total grep -v arg > tt  0.02s user 0.02s system 0% cpu 1:05:18.20
total
