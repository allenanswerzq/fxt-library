...
//% Triangle read by rows: T(n,k) is the number of Dyck paths of semilength n
//and height k (1<=k<=n). % Same as: Catalan restricted growth strings (RGS) by
//max digit.
...
int main(int argc, char **argv) {
  ...
  //    for (ulong j=0,s=0; j<n; ++j)  { s+=md[j]; cout << s << ", "; }  //
  //    A080935
