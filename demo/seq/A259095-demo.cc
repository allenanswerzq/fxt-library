...
//% Number of arrangements of n pennies in rows, r pennies in the bottom row,
//and each higher row consisting of contiguous pennies. % Computed via integer
//partitions into distinct parts as ascending list of parts.
