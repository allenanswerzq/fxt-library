...
const char *vv[] = {
    "0000001000000", "0000101",
    //    "00111111",
    //    "00111100",
    "001111000011110111", "111101100011100100", "00000001", "10101010",
    "_83828180",
...
int main() {
  for (ulong i = 0;; ++i) {
    ulong v;
    if (vv[i][0] != '_')
      v = strtoul(vv[i], nullptr, 2);
    else
      v = strtoul(vv[i] + 1, nullptr, 16);
