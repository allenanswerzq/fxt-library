...
int main(int argc, char **argv) {
  ...
  ulong w = 0;
  NXARG(w,
        "If !=0 then draw curve from paper-folding sequence with control world "
        "w");
  //    cout << "%% style=" << style << endl;
  if (0 == w) w = ~0UL;
...
/// make-target2: "1demo DSRC=demo/bits/dragon-curve-texpic-demo.cc
