...
const char *vv[] = {"00011010", "00010000", "00001111", "01001001", "00000000"};
// -------------------------
...
#define CHECK()                 \
  {                             \
    ...
    S.prev();                   \
    S.next();                   \
    jjassert(w == S.current()); \
  }

void show_subsets(ulong v) {
  bit_subset S(v);
  //    cout << endl;
  //    cout << "v=" << v;
  //    print_bin( " == ", v, ld(v)+1, "01");
  print_bin("V ", S.full_set(), 8);
  cout << endl;

  print_bin("U ", S.current(), 8);
  cout << endl;
  do {
    print_bin("  ", S.next(), 8);
    cout << endl;
...
arg 1: 4294967295 == w  [word whose subsets are shown (0==> some default words)]
default=0 arg 2: 0 == dir  [With benchmark: whether to go backwards]  default=0
forward:
...
arg 1: 4294967295 == w  [word whose subsets are shown (0==> some default words)]
default=0 arg 2: 1 == dir  [With benchmark: whether to go backwards]  default=0
backward:
