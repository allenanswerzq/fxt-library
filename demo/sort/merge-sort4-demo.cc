...
int main(int argc, char **argv) {
  ...
  //    NXARGSTR(str, "String to sort",
  //    "TheBinarySplittingSchemeForProductsOrSo"); NXARGSTR(str, "String to
  //    sort", "2705520349807111576968325245272272053880818086");
