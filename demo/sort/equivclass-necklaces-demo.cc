...
int main(int argc, char **argv) {
  ...
  ulong cq = 0;
  NXARG(cq,
        "Whether equivalence includes complements (==> unlabeled necklaces).");
  ...
  ulong *e = new ulong[n];
  if (0 == cq)
    equivalence_classes(s, n, n_equiv_q, e);
  else
    equivalence_classes(s, n, nu_equiv_q, e);
...
classes' | cut -d= -f2; done 1:  2 2:  3 3:  4 4:  6 5:  8 6:  14 7:  20 8:  36
9:  60
10:  108
11:  188
12:  352
...
classes' | cut -d= -f2; done 1:  1 2:  2 3:  2 4:  4 5:  4 6:  8 7:  10 8:  20
9:  30
10:  56
11:  94
12:  180
...
/// make-target2: "1demo DSRC=demo/sort/equivclass-necklaces-demo.cc
