...
int main(int argc, char **argv) {
  ...
  ulong cq = 0;
  NXARG(cq,
        "Whether equivalence includes complements (==> unlabeled bracelets).");
  ...
  ulong *e = new ulong[n];
  if (0 == cq)
    equivalence_classes(s, n, b_equiv_q, e);
  else
    equivalence_classes(s, n, bu_equiv_q, e);
...
/*
 # of bracelets:
% for n in $(seq 1 14); do echo -n "$n: "; ./bin $n 0 | grep 'equivalence
classes' | cut -d= -f2; done 1:  2 2:  3 3:  4 4:  6 5:  8 6:  13 7:  18 8:  30
9:  46
10:  78
11:  126
12:  224
...
% for n in $(seq 1 14); do echo -n "$n: "; ./bin $n 1 | grep 'equivalence
classes' | cut -d= -f2; done 1:  1 2:  2 3:  2 4:  4 5:  4 6:  8 7:  9 8:  18 9:
23 10:  44 11:  63 12:  122 13:  190 14:  362
...
/// make-target2: "1demo DSRC=demo/sort/equivclass-bracelets-demo.cc
