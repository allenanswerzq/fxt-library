...
int main(int argc, char **argv) {
  ...
  NXARG(
      cq,
      "Whether equivalence includes complements (==> unlabeled bit-strings).");
  ...
  ulong *e = new ulong[n];
  if (0 == cq)
    equivalence_classes(s, n, bs_equiv_q, e);
  else
    equivalence_classes(s, n, bsu_equiv_q, e);
...
/*
% for n in $(seq 1 15) ; do  echo -n $n:; ./bin $n 0 | grep 'of equiv'| cut -d=
-f2; done 1: 2 2: 3 3: 6 4: 10 5: 20 6: 36 7: 72 8: 136 9: 272 10: 528 11: 1056
12: 2080
13: 4160
14: 8256
15: 16512
...
% for n in $(seq 1 15) ; do  echo -n $n:; ./bin $n 1 | grep 'of equiv'| cut -d=
-f2; done 1: 1 2: 2 3: 3 4: 6 5: 10 6: 20 7: 36 8: 72 9: 136 10: 272 11: 528 12:
1056 13: 2080 14: 4160 15: 8256 http://oeis.org/A005418 Number of n-bead
black-white reversible strings; also binary grids;
*/
...
/// make-target2: "1demo DSRC=demo/sort/equivclass-bitstring-demo.cc
