...
// Cf. comb/partition-binary-asc-demo.cc for partitions (as weakly ascending
// lists) Cf. comb/partition-binary-desc-demo.cc for partitions (as weakly
// descending lists) Cf. comb/composition-nz-odd-demo.cc for odd parts Cf.
// comb/composition-nz-demo.cc for all compositions
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-binary-demo.cc
