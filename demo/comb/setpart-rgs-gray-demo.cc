...
//+ 1. % Minimal-change order for set partitions, %  note that the RGS can
//change in more than one position.
...
/// make-target2: "1demo DSRC=demo/comb/setpart-rgs-gray-demo.cc
