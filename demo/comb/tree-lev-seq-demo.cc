...
// Cf. comb/ordered-tree-branching-seq-demo.cc branching sequences for ordered
// trees
...
//        if ( T.min_limb_length() != 2 )  continue;  // A000000 (not: A155099)
    ...
    //        cout << "    Bq =[ "; for (ulong i=0; i<n; ++i)  cout <<
    //        T.is_branch(i) << " "; cout << "]"; cout << "    Lq =[ "; for
    //        (ulong i=0; i<n; ++i)  cout << T.is_leaf(i) << " "; cout << "]";
    //        cout << "    LL =[ "; for (ulong i=0; i<n; ++i)  cout <<
    //        T.limb_length(i) << " "; cout << "]"; cout << setw(4) <<
    //        T.min_limb_length(); cout << setw(4) << T.max_limb_length(); cout
    //        << setw(4) << T.height();

    //        T.print_branching_numbers("    ");  // out-degrees (dots for
    //        zeros) T.print_base_seq("    ");
