...
int main(int argc, char **argv) {
  ...
  ulong m = P.num_parts();
  do {
    //        if ( ! P.first_sort() )  continue;  // only first sort ==1,
    //        A227135 if ( P.first_sort() )  break;  // only first sort ==0,
    //        A227134
...
/// make-target2: "1demo DSRC=demo/comb/partition-asc-perim-demo.cc
