...
int main(int argc, char **argv) {
  ...
  do {
    ...
    //        { ulong j=m; do { --j; cout << " " << x[j]; } while (j); }  //
    //        weakly descending list
    cout << " [" << setw(2) << m << "] ";
...
default=0 forward: ct=1064144451
...
default=0 backward: ct=1064144451
...
arg 1: 110 == n  [integer partitions of n]  default=10
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 forward: ct=607163746
...
arg 1: 110 == n  [integer partitions of n]  default=10
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 backward: ct=607163746
...
/// make-target2: "1demo DSRC=demo/comb/partition-asc-demo.cc
