  ...
  do {
    ...
    switch (sq) {
      ...
      case 7:  // position of first occurrence of max: A092921, cf. A175331
        ...
        //        case 8:  // position of last occurrence of max: trivially at
        //        end
        //            s = W.last_max_idx();
        //            break;
        //            // 1, 0,
      ...
      case 40:  // max frequency in histogram (of level seq.): same as number of
                // max level
        s = W.max_num_vals();
        break;
        // 0, 1,
...
/// makefile-dir: "../../"
/// make-target: "1demo
/// DSRC=demo/comb/balanced-ordered-tree-lev-seq-stats-demo.cc" make-target2:
/// "1demo DSRC=demo/comb/balanced-ordered-tree-lev-seq-stats-demo.cc
