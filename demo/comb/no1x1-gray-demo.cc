...
// == A074677 a(n)=Sum((-1)^(i+Floor(n/2))F(2i+e),(i=0,..,Floor(n/2))), where
F(n) = Fib(n)

no1x1 and no1xy1:
% echo $(for n in $(seq 0 17); do ./bin $n | grep -vE '1 .? .? 1' | grep ':  ' |
wc -l; done) 1 2 4 6 8 11 17 27 41 60 88 132 200 301 449 669 1001 1502
 == A079972
*/
