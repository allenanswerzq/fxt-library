...
//        if ( P.first_part() > 7 )  continue;  // max part
    ...
    //        if ( 0!=(P.data()[0]&1) )  continue; // largest part even: A027187
    //        (==even num parts)
    ...
    //        if ( 0==(P.data()[0]&1) )  continue; // largest part odd: A027193
    //        (==odd num parts)
...
/// make-target2: "1demo DSRC=demo/comb/partition-desc-demo.cc
