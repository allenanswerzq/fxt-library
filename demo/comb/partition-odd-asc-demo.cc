...
// Cf. comb/partition-odd-desc-demo.cc for partitions into odd parts as weakly
// descending lists Cf. comb/partition-dist-asc-demo.cc for partitions into
// distinct parts Cf. comb/partition-asc-demo.cc for partitions as weakly
// ascending list of parts Cf. comb/partition-demo.cc for partitions given as
// multiplicities of parts Cf. comb/composition-nz-demo.cc for all compositions
// as lists of parts
...
/// make-target2: "1demo DSRC=demo/comb/partition-odd-asc-demo.cc
