...
// Cf. comb/partition-asc-sorts2-demo.cc (partitions; lex: major by parts, minor
// by sorts) Cf. comb/composition-nz-sorts2-demo.cc (compositions; lex: major by
// parts, minor by sorts) Cf. comb/composition-nz-sorts-demo.cc (compositions;
// lex: major by sorts, minor by parts) Cf. comb/partition-asc-demo.cc for
// partitions (with one sort of parts)
...
/*
 echo $(for n in $(seq 0 15); do ./bin $n 2; done | g ct=) | sed 's/ ct=/, /g;
 s/ct=//'
*/
...
/// make-target2: "1demo DSRC=demo/comb/partition-asc-sorts-demo.cc
