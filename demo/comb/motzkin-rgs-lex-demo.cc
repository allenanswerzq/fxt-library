...
int main(int argc, char **argv) {
  ...
  ulong i = 1;
  NXARG(i,
        "At most i rises in a row; at most i+1 consecutive ones in the Dyck "
        "word");
  ...
  // 3 ==> (A036766),  4 ==> (A036767)
  // 5 ==> (A036768),  6 ==> (A036769)
  // i ==> g.f. A(x) where x*A(x) is the series reversion of
  // x/(1+x+x^2+...+x^(i+1)). i>=n-1 ==> Catalan RGS (A000108)
...
arg 2: 1 == i  [At most i rises in a row; at most i+1 consecutive ones in the
Dyck word]  default=1 ct=1129760415
...
arg 1: 23 == n  [Length of RGS]  default=6
arg 2: 1 == i  [At most i rises in a row; at most i+1 consecutive ones in the
Dyck word]  default=1 MOTZKIN_RGS_LEX_FIXARRAYS is defined ct=1129760415
...
/// make-target2: "1demo DSRC=demo/comb/motzkin-rgs-lex-demo.cc
