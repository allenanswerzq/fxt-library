...
// Cf. comb/setpart-p-rgs-lex-demo.cc for the "usual" RGS for set partitions
// into p parts Cf. comb/setpart-ck-rgs-demo.cc for the Cooper-Kennedy RGS
...
/// make-target2: "1demo DSRC=demo/comb/setpart-zero-map-rgs-demo.cc
