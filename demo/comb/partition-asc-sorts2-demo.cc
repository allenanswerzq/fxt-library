...
// Cf. comb/partition-asc-sorts-demo.cc (partitions; lex: major by sorts, minor
// by parts) Cf. comb/composition-nz-sorts2-demo.cc (compositions; lex: major by
...
/// make-target2: "1demo DSRC=demo/comb/partition-asc-sorts2-demo.cc
