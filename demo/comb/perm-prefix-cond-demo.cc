...
// Cf. comb/mixedradix-prefix-cond-demo.cc for mixed radix numbers with
// restricted prefixes.
...
// condition: abs(f[k]-k) >= 2
{
  ...
  //    if ( ak<=k )  return ( k-ak <= 1 );  else return true;  // A000079
  //    Powers of 2

  const ulong d = (ak > k ? ak - k : k - ak);

  return (d >=
          2);  // OEIS sequence A001883: 1, 4, 29, 206, 1708, 15702, 159737,
...
int main(int argc, char **argv) {
  ...
  switch (c) {
    ...
    case 1:
      ...
      perm = new perm_prefix_cond(n, cond_invol, visit);
      break;
    case 2:
    ...
    case 6:
      ...
      perm = new perm_prefix_cond(n, cond_dist, visit);
      break;

    case 7:
      cout << "Playground:" << endl;
      perm = new perm_prefix_cond(n, cond_dist_set, visit);
      break;
    case 8:
      cout << "Playground:" << endl;
      perm = new perm_prefix_cond(n, cond_gt_k2, visit);
      break;

    case 10:
      cout << "Playground:" << endl;
      perm = new perm_prefix_cond(n, cond_cyc_dist, visit);
      break;

    case 11:
      cout << "Canonical Gray cycles:" << endl;
      perm = new perm_prefix_cond(n, cond_gray, visit);
      break;

    case 12:
      cout << "Ascends and descends of length at least 2:" << endl;
      perm = new perm_prefix_cond(n, cond_asc_desc_geq_2, visit);
      break;
...
/// make-target2: "1demo DSRC=demo/comb/perm-prefix-cond-demo.cc
