...
default=0 COMPOSITION_NZ_FIXARRAYS defined. forward: ct=4294967296
...
default=0 COMPOSITION_NZ_FIXARRAYS defined. backward: ct=4294967296
...
arg 1: 33 == n  [compositions of n]  default=7
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 forward: ct=4294967296
...
arg 1: 33 == n  [compositions of n]  default=7
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 backward: ct=4294967296
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-demo.cc
