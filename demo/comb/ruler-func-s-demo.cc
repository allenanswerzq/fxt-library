...
Timing: (AMD Phenom II X4 945 3000MHz)
 ...
 time ./bin 30 2
arg 1: 30 == n  [Stop when n+1 is encountered (==>s**n - 1  elements).]
default=3 arg 2: 2 == s  [ruler function for radix s (s>=2)]  default=3
./bin 30 2  2.85s user 0.00s system 99% cpu 2.858 total
 ==> 2^30/2.85 == 376,751,517 per second

 time ./bin 19 3
arg 1: 19 == n  [Stop when n+1 is encountered (==>s**n - 1  elements).]
default=3 arg 2: 3 == s  [ruler function for radix s (s>=2)]  default=3
./bin 19 3  3.58s user 0.00s system 99% cpu 3.585 total
 ==> 3^19/3.58 == 324,654,041 per second

 time ./bin 15 4
arg 1: 15 == n  [Stop when n+1 is encountered (==>s**n - 1  elements).]
default=3 arg 2: 4 == s  [ruler function for radix s (s>=2)]  default=3
