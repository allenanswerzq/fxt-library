...
46368 A000045 Fibonacci numbers: F(n) = F(n-1) + F(n-2), F(0) = 0, F(1) = 1,

r=2:
3 5 11 21 43 85 171 341 683 1365 2731 5461 10923 21845 43691 87381 174763 349525
699051 A001045 Jacobsthal sequence: a(n) = a(n-1) + 2a(n-2).

r=3:
4 7 19 40 97 217 508 1159 2683 6160 14209 32689 75316 173383 399331 919480
2117473 A006130 a(n) = a(n-1) + 3a(n-2), a(0) = a(1) = 1.


r=4:
5 9 29 65 181 441 1165 2929 7589 19305 49661 126881 325525 833049 2135149
5467345 A006131 a(n) = a(n-1) + 4*a(n-2)

r=5:
6 11 41 96 301 781 2286 6191 17621 48576 136681 379561 1062966 2960771 8275601
23079456 A015440 Generalized Fibonacci numbers. [a(n-1) + 5*a(n-2)]
