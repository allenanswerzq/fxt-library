...
//% Cf. OEIS sequences A061343 (all shifted tableaux; using condition
//is_shifted(1)), %   A210736 (shifted, height <= 2), A082395 (shifted, height
//<= 3). % Cf. OEIS sequences A161125 (descent numbers), A225617 (strict
...
int main(int argc, char **argv) {
  ...
  ulong m = 0;
  NXARG(m,
        "Number of allowed values for digits\n"
...
/// make-target2: "1demo DSRC=demo/comb/young-tab-rgs-demo.cc
