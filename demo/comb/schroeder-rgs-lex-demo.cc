...
// m0 == 0 ==> ,  g.f. (1 + x - sqrt(1 - 6*x + x^2))/(4*x) = 2/(1 + x + sqrt(1 -
// 6*x + x^2)). m0 == 1 ==> ,  g.f. (1 - x - sqrt(1 - 6*x + x^2))/(2*x) m0 == 2
// ==> A177010,  g.f. ((1-x)^2+(1+x)*sqrt(1-6*x+x^2))/2 (abs. values) m0 == 3
// ==> A000000
...
/// make-target2: "1demo DSRC=demo/comb/schroeder-rgs-lex-demo.cc
