...
// Cf. comb/composition-nz-first-max-demo.cc for all compositions with fist part
// maximal Cf. comb/ordered-tree-lev-seq-demo.cc for all ordered trees. Cf.
// comb/tree-lev-seq-demo.cc for unordered trees.
...
/// make-target2: "1demo DSRC=demo/comb/balanced-ordered-tree-lev-seq-demo.cc
