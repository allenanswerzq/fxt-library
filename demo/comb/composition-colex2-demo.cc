...
//% Generating all compositions of n into k parts in co-lexicographic (colex)
//order. % Algorithm efficient also with sparse case, i.e. k much greater than
//n.
...
/// make-target2: "1demo DSRC=demo/comb/composition-colex2-demo.cc
