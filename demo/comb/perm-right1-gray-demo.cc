...
//% Gray code for falling factorial numbers where digit x is followed by x or
//more zeros.
...
void visit() {
  ...
  //    reverse(ff, n);  rfact2perm(ff, n+1, pp); reverse(ff, n);  // as rising
  //    factorial ffact2perm_swp(ff, n+1, pp);  // ==> perm == inverse perm
...
/// make-target2: "1demo DSRC=demo/comb/perm-right1-gray-demo.cc
