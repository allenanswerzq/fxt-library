...
// Cf. bits/fibrep2-demo.cc for binary NAFs (Fibonacci words) in lexicographic
// order in a binary word.
...
/// make-target2: "1demo DSRC=demo/comb/mixedradix-naf-demo.cc
