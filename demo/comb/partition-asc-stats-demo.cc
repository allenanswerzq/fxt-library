...
int main(int argc, char **argv) {
  ...
  do {
    ...
    switch (sq) {
      ...
      case 3:  // number of largest parts: A026794 (same as value of smallest
               // part)
        s = W.num_max_val();
        break;
        //  0:  1,
      ...
      case 40:  // position of first occurrence of largest part: A097364,
                // A116685(tabf)
        s = W.first_max_idx();
        break;
        //  0:  1,
      ...
      case 43:  // position of last occurrence of smallest part: A096144 (same
                // as number of smallest values)
        // not: A091602
      ...
      case 71:  // number of non-flat steps: A116608 (same as "number of
                // distinct parts")
...
OEIS example:
 q=0; for n in $(seq 0 15) ; do ./bin $n $q | grep ', $' ; done | nl -v0 -s':  '
-w2 -n rz
...
/// make-target2: "1demo DSRC=demo/comb/partition-asc-stats-demo.cc
