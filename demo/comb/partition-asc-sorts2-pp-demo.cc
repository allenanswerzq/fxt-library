...
int main(int argc, char **argv) {
  ...
  for (ulong k = 3; k < (ulong)argc; ++k)
    vns[k - 3] = strtoul(argv[k], nullptr, 10);

  partition_asc_sorts2_pp P(n, ns, (argc > 3 ? vns : nullptr));
...
//#define STATS
  ...
  do {
       ...
       // ns=32 ==> A022596, prod(n>=1, 1+q^n )^32
        ...
        if ( ! q )  continue;
#endif
#if 0  // no three parts are of same size, no two parts (of same size) of same
       // sort, last part must be first sort. ns=2 ==> A059618 (strongly
       // unimodal partitions)
...
#ifdef STATS  // A091355
    // Columns 1-5 are repectively A000041, A091356, A091357, A091358, and
    // A091359. Columns converge to A091360.
    const ulong *S = P.sdata();
    ulong t = 0;
    for (ulong j = 0; j < m; ++j)
      if (S[j] > t) t = S[j];
...
#if 0  // only odd parts: A000000 (not A242362 "Plane partitions into odd
       // parts")
...
arg 2: 1 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 ct=607163746
...
arg 2: 2 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 ct=962759294
...
arg 2: 4 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 ct=1837560960
...
arg 2: 8 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 ct=4053978040
...
arg 1: 110 == n  [partitions of n]  default=6
arg 2: 1 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 PARTITION_ASC_SORTS2_PP_FIXARRAYS defined. ct=607163746
...
arg 1: 60 == n  [partitions of n]  default=6
arg 2: 2 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 PARTITION_ASC_SORTS2_PP_FIXARRAYS defined. ct=962759294
...
arg 1: 35 == n  [partitions of n]  default=6
arg 2: 4 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 PARTITION_ASC_SORTS2_PP_FIXARRAYS defined. ct=1837560960
...
arg 1: 22 == n  [partitions of n]  default=6
arg 2: 8 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 PARTITION_ASC_SORTS2_PP_FIXARRAYS defined. ct=4053978040
...
/// make-target2: "1demo DSRC=demo/comb/partition-asc-sorts2-pp-demo.cc
