...
// Cf. comb/partition-desc-demo.cc for the corresponding partitions as weakly
// descending lists Cf. comb//young-tab-rgs-demo.cc for all Young tableaux (as
// RGS)
...
/// make-target2: "1demo DSRC=demo/comb/partition-rgs-lex-demo.cc
