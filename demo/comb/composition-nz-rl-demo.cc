...
//            if ( x[j] == 1 )  { q=false;  break; }
    ...
    //        cout << m-1 << ", ";  continue;  // A005811: number of 1's in Gray
    //        code for n cout << P.last_part() << ", ";  continue;  // A136480
    ...
    //        print_vec("        ", C, nc); // endo order: pointer to ones in RL
    //        word
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-rl-demo.cc
