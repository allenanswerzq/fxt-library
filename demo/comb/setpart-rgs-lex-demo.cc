...
//% strings s[0, 1, ..., n-1] such that s[k] <= max(s[0], s[1], ..., s[k-1])
//+ 1. % Lexicographic order.

//#define TIMING  // uncomment to disable printing

// Cf. comb/setpart-p-rgs-lex-demo.cc for the RGS for set partitions into p
// parts Cf. comb/setpart-ck-rgs-demo.cc for the Cooper-Kennedy RGS Cf.
// comb/setpart-zero-map-rgs-demo.cc for RGS using certain maps
...
//            }  // both ==> A005773
    ...
    //        if ( ! is_noncrossing_setpart_rgs(P.data(), n) )  continue;  //
    //        A000108
...
/// make-target2: "1demo DSRC=demo/comb/setpart-rgs-lex-demo.cc
