...
// Cf. comb/composition-nz-subset-lex-demo.cc for compositions in subset-lex
// order
...
default=0 COMPOSITION_NZ_GRAY_FIXARRAYS defined. forward: ct=536870912
...
default=0 COMPOSITION_NZ_GRAY_FIXARRAYS defined. backward: ct=536870912
...
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 COMPOSITION_NZ_GRAY_FIXARRAYS defined. forward: ct=1073741824
...
arg 1: 31 == n  [compositions of n]  default=7
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 COMPOSITION_NZ_GRAY_FIXARRAYS defined. backward: ct=1073741824
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-gray-demo.cc
