...
//        print_vec("    ", R.m_, n, true);
    ...
    //        for (ulong k=1; k<n; ++k)  nd += ( x[k-1] >= x[k] );  //
    //        non-ascends for (ulong k=1; k<n; ++k)  nd += ( x[k-1] < x[k] ); //
    //        ascends for (ulong k=1; k<n; ++k)  nd += ( x[k-1] < x[k] );  //
    //        non-ascends for (ulong k=1; k<n; ++k)  nd += ( x[k-1] == x[k] );
    //        // equality for (ulong k=1; k<n; ++k)  nd += ( x[k-1] != x[k] );
    //        // non-equality
