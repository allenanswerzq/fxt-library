...
// Cf. comb/partition-strongly-decr-desc-demo.cc for strongly decreasing
// partitions Cf. comb/partition-nonsquashing-desc-demo.cc for non-squashing
// partitions
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-superdiagonal-demo.cc
