...
// Cf. comb/partition-2fall-desc-demo.cc for partitions such that 2*a[k] <=
// a[k-1] Cf. comb/partition-2fall-asc-demo.cc for partitions such that a[k] >=
// 2*a[k-1]
...
/// make-target2: "1demo DSRC=demo/comb/partition-s-desc-demo.cc
