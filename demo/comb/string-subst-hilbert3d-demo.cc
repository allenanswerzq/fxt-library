...
#include "array-len.h"
#include "comb/lindenmayer-system.h"  // easier to use than string_subst
...
void make_axis_rotation(ulong n, int phi, M3 &M)
...
int main(int argc, char **argv) {
  ...
  const std::vector<std::string> h3d_rules = {
      // recursion:
  ...
  //    string_subst S(ldn);
  //    S.set_axiom("a");
  //    S.set_all_rules( h3d_rules, ARRAY_LEN(h3d_rules) );
  lindenmayer_system S(ldn, "a", h3d_rules);
  jjassert(S.first());

  M3 Ri(3);
  Ri.unit();  // current orientation
  setup_rot_mat();
...
/// MyRelDir: "demo/comb"
/// makefile-dir: "../../"
/// make-target: "1demo DSRC=demo/comb/string-subst-hilbert3d-demo.cc"
/// make-target2: "1demo DSRC=demo/comb/string-subst-hilbert3d-demo.cc
