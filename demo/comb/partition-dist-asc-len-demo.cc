...
// Cf. comb/partition-dist-asc-demo.cc for partitions into distinct parts in
// lexicographic order Cf. comb/partition-desc-bb-demo.cc all partitions, with
// bounds for size and number of parts
...
/// make-target2: "1demo DSRC=demo/comb/partition-dist-asc-len-demo.cc
