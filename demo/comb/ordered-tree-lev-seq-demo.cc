...
//        if ( T.min_limb_length() != 3 )  continue;  // A000000
    ...
    //        T.is_branch(i) << " "; cout << "]"; cout << "    Bn =[ "; for
    //        (ulong i=0; i<=n; ++i)  cout <<
    //        tree_lev_seq_branching_number(T.data(), n, i) << " "; cout << "]";
    //        cout << "    Lq =[ "; for (ulong i=0; i<=n; ++i)  cout <<
    //        T.is_leaf(i) << " "; cout << "]"; cout << "    LL =[ "; for (ulong
    //        i=0; i<=n; ++i)  cout << T.limb_length(i) << " "; cout << "]";
    ...
    //            for (ulong j=0; j<N; ++j)  jjassert( b[j] ==
    //            T.branching_number(j) );
    //        }
...
/// make-target2: "1demo DSRC=demo/comb/ordered-tree-lev-seq-demo.cc
