...
// parts Cf. comb/partition-dist-asc-demo.cc for partitions into distinct parts
...
arg 2: 0 == aa  [Whether to render as compositions (1) or fountains of coins
(2)]  default=0 ct=3566196321
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-left-smooth-demo.cc
