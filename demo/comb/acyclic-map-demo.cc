...
#ifdef TIMING
#ifdef ACYCLIC_MAP_MAX_ARRAY_LEN
  cout << "ACYCLIC_MAP_MAX_ARRAY_LEN is defined" << endl;
#endif
  M.first();
  do {
    ++ct;
...
arg 2: 10 == rr  [Base (radix) of digits (0==>falling factorial, 1==>rising
factorial)]  default=10 ct=100000000
