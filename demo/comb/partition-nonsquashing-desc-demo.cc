...
//% Cf. OEIS sequences A018819, A000123 (non-squashing), and A040039 (strongly
//decreasing).

// Cf. comb/partition-binary-desc-demo.cc for binary partitions as weakly
// descending lists Cf. comb/partition-strongly-decr-desc-demo.cc for strongly
// decreasing partitions Cf. comb/partition-desc-demo.cc for partitions as
// weakly descending lists
...
/*
## A018819:
echo $(for n in $(seq 1 50); do ./bin $n 0 ; done | grep ct ) | sed 's/ ct=/,
/g;'

## A040039:
echo $(for n in $(seq 1 50); do ./bin $n 1 ; done | grep ct ) | sed 's/ ct=/,
/g;'
...
/// make-target2: "1demo DSRC=demo/comb/partition-nonsquashing-desc-demo.cc
