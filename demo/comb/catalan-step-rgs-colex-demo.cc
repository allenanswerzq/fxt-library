...
arg 2: 0 == bq  [With benchmark: whether do generate in backward order]
default=0 forward: ct=1767263190
./bin 19 0  5.42s user 0.00s system 99% cpu 5.426 total
 ==> 1767263190/5.42 == 326,063,319 per second

 time ./bin 19 1
arg 1: 19 == n  [Catalan (step-)RGS for paths from (0,0) to (n,n)]  default=5
arg 2: 1 == bq  [With benchmark: whether do generate in backward order]
default=0 backward: ct=1767263190
...
/// make-target2: "1demo DSRC=demo/comb/catalan-step-rgs-colex-demo.cc
