...
arg 2: 0 == aa  [If aa!=0, render as compositions (1) or fountains of coins (2)]
default=0 ct=768425125
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-left-2smooth-demo.cc
