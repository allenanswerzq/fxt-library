...
//%   compositions of n into one sort of 1's, two sorts of 2's, ..., k sorts of
//k's. % Cf. OEIS sequences (compositions of n into (all) parts of s kinds): %
//A011782 (s=1), A025192 (s=2), A002001 (s=3), A005054 (s=4), % A052934 (s=5),
//A055272 (s=6), A055274 (s=7), and A055275 (s=8).
...
arg 1: 31 == n  [compositions of n]  default=5
arg 2: 1 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 COMPOSITION_NZ_SORTS2_PP_FIXARRAYS defined. ct=1073741824
...
arg 1: 20 == n  [compositions of n]  default=5
arg 2: 2 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 COMPOSITION_NZ_SORTS2_PP_FIXARRAYS defined. ct=2324522934
...
arg 1: 13 == n  [compositions of n]  default=5
arg 2: 4 == ns  [Number of sorts for parts by size (0==>1,2,3,4,...,n)]
default=0 COMPOSITION_NZ_SORTS2_PP_FIXARRAYS defined. ct=976562500
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-sorts2-pp-demo.cc
