...
// Cf. comb/mixedradix-demo.cc for lexicographic ordering (wrt. delta sets).
...
int main(int argc, char **argv) {
  ...
  for (ulong k = 3; k < (ulong)argc; ++k)
    r[k - 3] = strtoul(argv[k], nullptr, 10);

  mixedradix_gslex_alt M(n, rr, (argc > 3 ? r : nullptr));
  M.print_nines("Nines: ");
  cout << endl;
#endif
...
/// make-target2: "1demo DSRC=demo/comb/mixedradix-gslex-alt-demo.cc
