...
//% Catalan restricted growth strings (RGS) and parentheses strings in
//minimal-change order.

// Cf. comb/catalan-rgs-demo.cc for fast iterative generation of lex order.
// Cf. comb/catalan-rgs-gray-demo.cc for fast iterative generation of the Gray
// code.
...
arg 2: 1 == xdr  [Change direction in recursion ==> minimal-change order]
default=1 arg 3: -1 == dr0  [Starting direction in recursion (+-1)]  default=-1
 ct=477638700
