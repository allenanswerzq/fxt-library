...
// Cf. comb/partition-odd-asc-demo.cc for partitions into odd parts as weakly
// ascending lists Cf. comb/partition-asc-demo.cc for partitions as weakly
// ascending lists
...
/// make-target2: "1demo DSRC=demo/comb/partition-odd-desc-demo.cc
