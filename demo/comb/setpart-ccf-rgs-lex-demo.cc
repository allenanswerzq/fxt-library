...
int main(int argc, char **argv) {
  ...
  do {
       ...
       // 1, 1, 1, 1, 3, 6, 19, 64, 235, 982, 4430, 21583, 113115, 632230,
       // 3750449
    ...
    //        print_ccf("    ", Z, n);  // set partition with last elements
    //        minimal
...
/// make-target2: "1demo DSRC=demo/comb/setpart-ccf-rgs-lex-demo.cc
