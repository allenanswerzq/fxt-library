...
default=0 forward: ct=479001600
...
default=0 backward: ct=479001600
...
arg 1: 11 == n  [Number of digits]  default=3
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 MIXEDRADIX_RFACT_MAX_ARRAY_LEN is defined forward: ct=479001600
...
arg 1: 11 == n  [Number of digits]  default=3
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 MIXEDRADIX_RFACT_MAX_ARRAY_LEN is defined backward: ct=479001600
...
/// make-target2: "1demo DSRC=demo/comb/mixedradix-rfact-demo.cc
