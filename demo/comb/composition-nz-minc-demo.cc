...
//%   "MacMahon's Partition Analysis V: Bijections, Recursions, and Magic
//Squares", %   in: Algebraic Combinatorics and Applications, proceedings of
//Euroconference Alcoma 99, %   September 12-19, 1999, Goessweinstein, Germany,
//%   A. Betten, A. Kohnert, R. Laue, A. Wassermann eds., Springer-Verlag,
//pp.1-39, (2001). % See also: %   Christian Elsholtz, Clemens Heuberger, Helmut
//Prodinger: %   "The number of Huffman codes, compact trees, and sums of unit
//fractions", %   arXiv:1108.5964 [math.CO], (30-August-2011).
//%
//% Cf. OEIS sequences:
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-minc-demo.cc
