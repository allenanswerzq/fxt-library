...
//% Generating all combinations in minimal-change order: revolving door
//algorithm.
...
// for n in $(seq 1 10); do for k in $(seq 1 $n); do ./bin $n $k || break 2;
// done; done
...
/// make-target2: "1demo DSRC=demo/comb/combination-revdoor-demo.cc
