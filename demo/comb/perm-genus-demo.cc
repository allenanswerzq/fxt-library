...
// Cf. seq/A178514-demo.cc for genus of derangements, involutions, and up-down
// permutations.
...
int main(int argc, char **argv) {
  ...
  do {
    ...
    if (gen == 0) {
      ...
      //            genus0_perm_to_paren(cpi, n, C, "1.");  // bit string form
      //            cpi[]
...
13: 742900, 29745716, 368588220, 1700309468, 2788065280, 1271140416, 68428800,
0, 0, 0, 0, 0, 0,
