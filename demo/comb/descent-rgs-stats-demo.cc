  ...
  do {
    ...
    switch (sq) {
      ...
      case 3:  // by number of zeros (=min values): A000000
        ...
        // 1, 21074, 101226, 157996, 122828, 57632, 18235, 4180, 729, 100, 11,
        // 1,
      ...
      case 6:  // position of last zero (last occurrence of min): A000000
        ...
        // 1, 1, 16413, 10504, 25477, 34636, 43396, 52854, 62292, 71816, 81561,
        // 85062,
      ...
      case 7:  // position of first occurrence of max: A000000
        ...
        // 1, 1024, 512, 6817, 8876, 20371, 33027, 49412, 67313, 84844, 100116,
        // 111700,
      ...
      case 10:  // number of odd values: (reversal of "even values")
        ...
        // 1, 2114, 18018, 61970, 117030, 134294, 96417, 42451, 10534, 1172, 11,
        // 1,
      ...
      case 11:  // number of even values: A000000
        ...
        // 1, 11, 1172, 10534, 42451, 96417, 134294, 117030, 61970, 18018, 2114,
        // 1,
      ...
      case 40:  // number of flat steps: A000000
        ...
        // 69972, 135234, 130900, 84480, 40920, 15708, 5082, 1320, 330, 55, 11,
        // 1, 435399, 839664, 811404, 523600, 253440, 98208, 31416, 8712, 1980,
        // 440, 66, 12, 1,
      ...
      case 41:  // number of non-flat steps: A000000
        ...
        // 1, 11, 55, 330, 1320, 5082, 15708, 40920, 84480, 130900, 135234,
        // 69972, 1, 12, 66, 440, 1980, 8712, 31416, 98208, 253440, 523600,
        // 811404, 839664, 435399,
      ...
      case 61:  // abs(#minval - #maxval): A000000
        ...
        // 20664, 61532, 114442, 134350, 94699, 41973, 12991, 2795, 510, 45, 12,
        // 0,
      ...
      case 95:  // value of last part: A000000
        ...
        // 484013, 484013, 484001, 483286, 469987, 383068, 183144, 31868, 962,
        // 0, 0, 0, 0,
...
/// make-target2: "1demo DSRC=demo/comb/descent-rgs-stats-demo.cc
