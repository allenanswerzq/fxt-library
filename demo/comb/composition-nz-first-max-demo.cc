...
//% Compositions of n into positive parts where no part is greater than the
//first. % Lexicographic order. % See OEIS sequencs A079500 and A007059.
...
int main(int argc, char **argv) {
  ...
  bool tq = 0;
  NXARG(tq,
        "Whether to print level sequences for corresponding (balanced) trees");
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-first-max-demo.cc
