...
int main(int argc, char **argv) {
  ...
  do {
    ...
    switch (sq) {
      ...
      case 3:  // by number of ones: A033185 (forests by number of trees), cf.
               // A106234
        s = W.num_val(1);
        ...
        //        case 4:  // by number of fixed points: A034781 (same as "by
        //        height")
        ...
        //            // 0, 0, 1, 76, 924, 2666, 3405, 2744, 1615, 728, 251, 64,
        //            11, 1,
      ...
      case 6:  // position of last one: A000000
        ...
        //        case 7:  // position of first occurrence of max: A034781 (same
        //        as "by height")
        //            s = W.first_max_idx();
        //            break;
        //            // 1, 0,
        ...
        //            // 0, 1, 41, 277, 528, 498, 308, 136, 43, 9, 1, 0,
        //            // 0, 1, 55, 509, 1198, 1323, 941, 487, 188, 53, 10, 1, 0,
        //            // 0, 1, 76, 924, 2666, 3405, 2744, 1615, 728, 251, 64,
        //            11, 1, 0,
...
/*
  ...
  OEIS example:
  q=0; for n in $(seq 1 13) ; do ./bin $n $q | grep ', $' ; done | nl -v1 -s':
' -w2 -n rz

C++ comment:
q=0;  for n in $(seq 1 13) ; do ./bin $n $q | grep ', $' ; done | sed 's/^/\/\/
/; s/ $//;'

Extract column c from stats q:
q=0;  c=0;  echo $(for n in $(seq 1 13) ; do ./bin $n $q | grep ', $' ; done |
cut -d, -f$((c+1))) | sed 's/ /, /g;'
...
/// make-target2: "1demo DSRC=demo/comb/tree-lev-seq-stats-demo.cc
