...
//+ 1. % Subset-lex order. % See Joerg Arndt, Subset-lex: did we miss an order?,
//(2014) %   http://arxiv.org/abs/1405.6503
...
/// make-target2: "1demo DSRC=demo/comb/setpart-rgs-subset-lex-demo.cc
