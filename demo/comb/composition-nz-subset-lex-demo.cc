...
// parts Cf. comb/partition-desc-demo.cc for partitions as weakly descending
// list of parts
...
int main(int argc, char **argv) {
  ...
  ulong m = P.num_parts();
  do {
    //        cout << P.last_part() << ",";  continue;  // A082850 (with
    //        backward order) cout << m-1 << ",";  continue;  // A100661 (with
    //        backward order)
...
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 COMPOSITION_NZ_SUBSET_LEX_FIXARRAYS defined. next() version A.
forward:
 ct=4294967296
...
time ./bin 33 1
arg 1: 33 == n  [compositions of n]  default=7
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 COMPOSITION_NZ_SUBSET_LEX_FIXARRAYS defined. prev() version A.
backward:
 ct=4294967296
...
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 forward: ct=2147483648
...
arg 1: 32 == n  [compositions of n]  default=7
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 COMPOSITION_NZ_SUBSET_LEX_FIXARRAYS defined. forward: ct=2147483648
...
arg 1: 32 == n  [compositions of n]  default=7
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 backward: ct=2147483648
...
arg 1: 32 == n  [compositions of n]  default=7
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 COMPOSITION_NZ_SUBSET_LEX_FIXARRAYS defined. backward: ct=2147483648
...
arg 1: 32 == n  [compositions of n]  default=7
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 next() version A. forward: ct=2147483648
...
arg 1: 32 == n  [compositions of n]  default=7
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 prev() version A. backward: ct=2147483648
...
arg 1: 32 == n  [compositions of n]  default=7
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 next() version B. forward: ct=2147483648
...
arg 1: 32 == n  [compositions of n]  default=7
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 prev() version B. backward: ct=2147483648
...
arg 1: 32 == n  [compositions of n]  default=7
arg 2: 0 == bq  [With benchmark: whether to generate in backward order]
default=0 COMPOSITION_NZ_SUBSET_LEX_FIXARRAYS defined. next() version B.
forward:
 ct=2147483648
...
arg 1: 32 == n  [compositions of n]  default=7
arg 2: 1 == bq  [With benchmark: whether to generate in backward order]
default=0 COMPOSITION_NZ_SUBSET_LEX_FIXARRAYS defined. prev() version B.
backward:
 ct=2147483648
...
/// make-target2: "1demo DSRC=demo/comb/composition-nz-subset-lex-demo.cc
