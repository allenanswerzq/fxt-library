...
Timing: (Intel(R) Core(TM) i7-8700K CPU @ 3.70GHz)
 ...
 time ./bin 32 20
arg 1: 32 == n  [Combinations (n choose k) in co-lexicographic order:  n>0]
default=7 arg 2: 20 == k  [ 0 < k <= n]  default=4 arg 3: 0 == rq  [Whether to
reverse order]  default=0 ct = 225792840
./bin 32 20  0.54s user 0.00s system 99% cpu 0.535 total
 ==> 225792840/0.54 == 418,134,888 per second

 time ./bin 32 12
arg 1: 32 == n  [Combinations (n choose k) in co-lexicographic order:  n>0]
default=7 arg 2: 12 == k  [ 0 < k <= n]  default=4 arg 3: 0 == rq  [Whether to
reverse order]  default=0 ct = 225792840
...
/// make-target2: "1demo DSRC=demo/comb/combination-colex-demo.cc
