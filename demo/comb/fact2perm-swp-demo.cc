...
int main(int argc, char **argv) {
  ...
  do {
    ...
    if (rq)
      rfact2perm_swp(fc, n, p);
    else
      ffact2perm_swp(fc, n, p);
    print_perm("  ", p, n, dfz);
    ...
    if (rq)
      perm2rfact_swp(ip, n, ifc);
    else
      perm2ffact_swp(ip, n, ifc);
    ...
    if (rq)
      perm2rfact_swp(p, n, t);
    else
      perm2ffact_swp(p, n, t);
    ...
    if (rq)
      rfact2invperm_swp(fc, n, t);
    else
      ffact2invperm_swp(fc, n, t);
...
/// make-target2: "1demo DSRC=demo/comb/fact2perm-swp-demo.cc
