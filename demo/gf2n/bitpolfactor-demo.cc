...
int main(int argc, char **argv) {
  ...
  for (ulong k = 0; k < np; ++k) {
    ...
    switch (frm) {
      case 0:
        bitpol_print_factorization("", f, e, fct);
        break;
      case 1:
        bitpol_print_coeff_factorization("", f, e, fct);
        break;
      case 2:
        bitpol_print_tex_factorization("", f, e, fct);
        break;
      case 3:
        bitpol_print_bin_factorization("", f, e, fct);
        break;
      case 4:
        bitpol_print_short_factorization("", f, e, fct);
        break;
    }
...
arg 2: 0 == np  [Number of polynomials to factor (0==>up to next degree)]
default=0 np=2097152 arg 3: 0 == frm  [Output form: 0==>ascii, 1==>coeff-list,
2==>TeX, 3==>bin]  default=0
