...
//% Generate all irreducible binary polynomials of given degree (from Lyndon
//words). % Indicate which are primitive (P) and normal (N).
...
int main(int argc, char **argv) {
  ...
  ulong st = 0;
  NXARG(st,
        "Stop after st polynomials where found,  zero==>list all polynomials");
...
for ((n=2;n<=25;++n)); do ./bin $n; done | grep -F ' n = '
 ...
 n = 14:    #irred. =1161  #prim. =756  #normal =448 = ( 291 prim. + 157
non-prim.) n = 15:    #irred. =2182  #prim. =1800  #normal =675 = ( 562 prim. +
113 non-prim.) n = 16:    #irred. =4080  #prim. =2048  #normal =2048 = ( 1017
prim. + 1031 non-prim.) n = 17:    #irred. =7710  #prim. =7710  #normal =3825 =
( 3825 prim. + 0 non-prim.) n = 18:    #irred. =14532  #prim. =7776  #normal
=5376 = ( 2870 prim. + 2506 non-prim.) n = 19:    #irred. =27594  #prim. =27594
#normal =13797 = ( 13797 prim. + 0 non-prim.) n = 20:    #irred. =52377  #prim.
=24000  #normal =24576 = ( 11255 prim. + 13321 non-prim.) n = 21:    #irred.
=99858  #prim. =84672  #normal =27783 = ( 23579 prim. + 4204 non-prim.) n = 22:
#irred. =190557  #prim. =120032  #normal =95232 = ( 59986 prim. + 35246
non-prim.) n = 23:    #irred. =364722  #prim. =356960  #normal =182183 = (
178259 prim. + 3924 non-prim.) n = 24:    #irred. =698870  #prim. =276480
#normal =262144 = ( 103680 prim. + 158464 non-prim.) n = 25:    #irred. =1342176
#prim. =1296000  #normal =629145 = ( 607522 prim. + 21623 non-prim.)
*/
...
/// make-target2: "1demo DSRC=demo/gf2n/all-irredpoly-demo.cc
