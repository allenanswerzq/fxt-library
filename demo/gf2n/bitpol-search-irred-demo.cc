...
#ifndef TIMING
      const ulong pn =
          (n == BITS_PER_LONG) ? 0 : n + 1;  // precision for printing
      cout << setw(4) << ct << ":";
...
arg 2: 300000 == st  [Stop after st polynomials where found,  zero==>list all
polynomials]  default=0 n = 35  ct = 300000
...
arg 2: 100000 == st  [Stop after st polynomials where found,  zero==>list all
polynomials]  default=0 n = 45  ct = 100000
...
arg 2: 100000 == st  [Stop after st polynomials where found,  zero==>list all
polynomials]  default=0 n = 59  ct = 100000
...
arg 2: 100000 == st  [Stop after st polynomials where found,  zero==>list all
polynomials]  default=0 n = 63  ct = 100000
...
/// make-target2: "1demo DSRC=demo/gf2n/bitpol-search-irred-demo.cc
