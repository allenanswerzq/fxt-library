...
int main(int argc, char **argv) {
  ...
  for (ulong k = 2; (ulong)argc > k; ++k)
    c |= (1UL << strtoul(argv[k], nullptr, 10));
  if (0 != c) c |= (1UL << n);
...
------------------------------------------------------------
  ...
  mm= .11111111111111111111   == 1048575  =  3 * 5^2 * 11 * 31 * 41  (maximal
order) h = .1................... (aux. bitmask) g = ...................1.
(element of maximal order) tv= ...1................. (traces of x^i) tr1e=
...1................. (element with trace=1)
