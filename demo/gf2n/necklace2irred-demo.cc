...
//% Convert necklaces to binary polynomials, especially irreducible and
//primitive ones.
...
int main(int argc, char **argv) {
  ...
  if (argc > 2) {
    ...
    for (ulong j = 2; j < (ulong)argc; ++j)
      c |= (1UL << strtoul(argv[j], nullptr, 10));
    n = highest_one_idx(c);
  }
...
/// make-target2: "1demo DSRC=demo/gf2n/necklace2irred-demo.cc
