...
//% Shift register sequences (SRS) for all primitive binary polynomials of given
//degree. % The sequences are maximum period sequences (m-sequences).
...
/// make-target2: "1demo DSRC=demo/gf2n/all-primpoly-srs-demo.cc
