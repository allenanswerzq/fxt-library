...
int main(int argc, char **argv) {
  ...
  ulong wh = 2;
  NXARG(wh,
        "What to do: 0==>just count  1==>print words  2==>also print matrix");
  ...
  do {
    ...
    if (vi)
      print_bin_vec("W=", vi, n);
    else
      print_bin_vec("  N=", T[1], n);
...
// OEIS:
// A056303
// ,0,1,1,2,3,5,9,16,28,51,93,170,315,585,1091,2048,3855,7280,13797,26214
// A000048
// ,1,1,1,1,2,3,5,9,16,28,51,93,170,315,585,1091,2048,3855,7280,13797,26214
...
/// make-target2: "1demo DSRC=demo/gf2n/bitmat-circulant-demo.cc
