...
int main(int argc, char **argv) {
  ...
  //    PAD( apply_permutation(gray_code, y, n) );  // same as: gray_permute(y,
  //    n) PAD( inverse_gray_permute(y, n) ); PAD(
  //    apply_permutation(negidx2lexrev, y, n) ); PAD(
  //    apply_permutation(lexrev2negidx, y, n) ); PAD(
  //    apply_permutation(blue_code, y, n) ); PAD( haar_permute(y, n) );
  PAD(zip(y, n));  // default
                   //    PAD( unzip(y, n) );
