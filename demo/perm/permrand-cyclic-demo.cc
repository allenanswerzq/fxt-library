...
#ifdef TIMING
void visit(const ulong *f, ulong n, ulong) { jjassert(is_cyclic(f, n)); }
#else   // TIMING
...
check whether unbiased:
 for n in $(seq 2 5); do ./bin $n 100000 | cut -d: -f2| sort | uniq -c | sort ;
done;
*/
...
/// make-target2: "1demo DSRC=demo/perm/permrand-cyclic-demo.cc
