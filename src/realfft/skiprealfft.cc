...
void skip_real_complex_fft(double *f, ulong n, ulong d, double *w)
...
void skip_real_complex_fft0(double *f, ulong n, ulong d, double *w)
// Compute real to complex FFT of the n elements
// [0],[d],[2d],[3d],...,[(n-1)*d]
...
void skip_complex_real_fft(double *f, ulong n, ulong d, double *w)
