...
static inline void cmult(double c, double s, double x, double y, double &u,
                         double &v)
// {u,v} <--| {x*c-y*s, x*s+y*c}
{
  u = x * c - y * s;
...
static inline void cmult(double c, double s, Complex x, Complex y, Complex &u,
                         Complex &v)
// {u,v} <--| {x*c-y*s, x*s+y*c}
...
static inline void cmult(Complex c, Complex s, Complex x, Complex y, Complex &u,
                         Complex &v)
// {u,v} <--| {x*c-y*s, x*s+y*c}
// used in generated complex fhts
{
...
static inline void cmult_inv(double c, double s, double x, double y, double &u,
                             double &v)
// {u,v} <--| {x*c+y*s, -x*s+y*c}
...
static inline void cmult_inv(double c, double s, Complex x, Complex y,
                             Complex &u, Complex &v)
// {u,v} <--| {x*c+y*s, -x*s+y*c}
// same as cmult(c, -s, x, y, u, v)
// used in generated complex fhts
...
static inline void cmult_inv(Complex c, Complex s, Complex x, Complex y,
                             Complex &u, Complex &v)
// {u,v} <--| {x*c+y*s, -x*s+y*c}
// same as cmult(c, -s, x, y, u, v)
// used in generated complex fhts
