...
void linear_scale(Type **f, ulong nr, ulong nc, Type nmi,
                  Type nma)  // new min, max
...
template <typename Type>
void linear_scale(Type **f, ulong nr, ulong nc, Type mi,
                  Type ma,             // old min, max
...
template <typename Type>
void log_scale(Type **f, ulong nr, ulong nc, double xi, double xa, Type nma) {
  Type mi, ma;
  min_max((const Type **)f, nr, nc, &mi, &ma);
