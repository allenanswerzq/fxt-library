...
// Copyright (C) 2010, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019 Joerg
// Arndt License: GNU General Public License version 3 or later, see the file
// COPYING.txt in the main directory.
