...
loop:
  switch (cr_->stpeek()) {
    ...
    case 3:
      ...
      cr_->stpoke(2);
      goto loop;  // shortcut: back to loop body
...
/// make-target2: "1demo DSRC=demo/ds/coroutine-paren-demo.cc
