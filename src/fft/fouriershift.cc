...
void fourier_shift(Complex *a, ulong n, double v)
...
void fourier_shift(double *fr, double *fi, ulong n, double v)
// auxiliary routine for FFTs:
// used for recursive FFTs and matrix FFTs (MFA)
//
// n := length of array
...
void fourier_shift_imag0(double *fr, double *fi, ulong n, double v)
// auxiliary routine for FFTs:
...
void fourier_shift(double *fr, double *fi, ulong n, double v, ulong k0,
                   ulong kn)
// auxiliary routine for FFTs
//
...
void fourier_shift_imag0(double *fr, double *fi, ulong n, double v, ulong k0,
                         ulong kn)
// auxiliary routine for FFTs
// (fr[k], fi[k]) *= exp((k0+k)*v*sqrt(-1)*2*pi/n) for k = 0...kn-1
// assume fi[] is zero
