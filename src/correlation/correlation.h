...
void fft_complex_correlation(double *fr, double *fi, double *gr, double *gi,
                             ulong ldn);

// correlation/slowcocorr.cc:
void slow_complex_correlation(const double *fr, const double *fi,
                              const double *gr, const double *gi, double *hr,
                              double *hi, ulong n);
void slow_complex_correlation(const double *fr, const double *fi, double *gr,
                              double *gi, ulong n);
