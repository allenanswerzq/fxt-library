...
// Reurn probability for closing cycle with n elements.
{
  if (n < NUM_PBR)
    ...
    return 1.0 / (double)n;  // relative error < 1.0e-32
}
// -------------------------

template <typename Type>
inline void random_derange(Type *f, ulong n, ulong *tr = nullptr,
...
inline void random_derangement(ulong *f, ulong n, ulong *tr = nullptr,
                               double *tb = nullptr, bool bi = false)
