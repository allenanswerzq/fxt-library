...
void gray_permute_cycle(Type *f, ulong s, ulong len)
...
template <typename Type>
void inverse_gray_permute_cycle(Type *f, ulong s, ulong len)
// moves one cycle of length len starting at index s
...
template <typename Type>
void gray_permute_ge_512(Type *f, ulong n)
...
template <typename Type>
void inverse_gray_permute_ge_512(Type *f, ulong n)
// permutes the upper half for lenths >= 512
// called by inverse_gray_permute()
{
  xm[0] = 1;
...
// used by:
template <typename Type>
void half_gray_permute(Type *f, ulong n)
