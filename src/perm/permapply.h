...
template <typename Type>
void apply_permutation(const ulong *x, Type *restrict f, ulong n,
                       bitarray *bp = nullptr)
// Apply the permutation x[] to the array f[]
...
template <typename Type>
void apply_inverse_permutation(const ulong *x, const Type *f, Type *restrict g,
                               ulong n)
...
template <typename Type>
void apply_inverse_permutation(const ulong *x, Type *restrict f, ulong n,
                               bitarray *bp = nullptr)
// Apply the inverse permutation of x[] to the array f[]
