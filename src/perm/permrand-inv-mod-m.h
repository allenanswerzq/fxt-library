...
inline void perm_fix_inv_mod(ulong *x, ulong n, ulong r, ulong m,
                             ulong *tfc = nullptr)
...
{
  ulong *fc = tfc;
  if (tfc == nullptr) fc = new ulong[n - 1];
  ...
  if (tfc == nullptr) delete[] fc;
}
// -------------------------

inline void random_inv_mod_m_permutation(ulong *p, ulong n, ulong r, ulong m,
                                         ulong *tfc = nullptr)
