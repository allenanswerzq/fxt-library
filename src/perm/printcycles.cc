...
void print_cycles(const char *bla, const ulong *f, ulong n,
                  bitarray *tb /*=nullptr*/)
...
//   8:  [ 1 2 0 3 ]    (0, 1, 2) (3)
{
  ...
  bitarray *b = tb;
  if (tb == nullptr) b = new bitarray(n);
  b->clear_all();
...
ulong print_cycle(const ulong *f, ulong e0 /*=nullptr*/)
...
void print_inv_perm_code(const char *bla, const ulong *f, ulong n,
                         bitarray *tb /*=nullptr*/)
