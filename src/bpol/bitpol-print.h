...
// x^{7} + x^{4} + x^{3} + 1  ==   \left(x + 1\right)^{5} \cdot  \left(x^{2} + x
// + 1\right)
//>>
...
void bitpol_print_factorization(const char *bla, const ulong *f, const ulong *e,
                                ulong fct);
void bitpol_print_bin_factorization(const char *bla, const ulong *f,
                                    const ulong *e, ulong fct);
void bitpol_print_coeff_factorization(const char *bla, const ulong *f,
                                      const ulong *e, ulong fct);
void bitpol_print_tex_factorization(const char *bla, const ulong *f,
                                    const ulong *e, ulong fct);
void bitpol_print_short_factorization(const char *bla, const ulong *f,
                                      const ulong *e, ulong fct);
