...
static const ulong rabin_tab[] = {
    ...
    4UL,    // x = 4  (bits: ........1..)    OPS:  sqr 2 times,    finally sqr 2
            // times
    0UL,    // x = 5  (bits: ...........)    OPS:   finally sqr 5 times
    12UL,   // x = 6  (bits: .......11..)    OPS:  sqr 2 times,   sqr 1 times,
            // finally sqr 3 times
    0UL,    // x = 7  (bits: ...........)    OPS:   finally sqr 7 times
    16UL,   // x = 8  (bits: ......1....)    OPS:  sqr 4 times,    finally sqr 4
            // times
    8UL,    // x = 9  (bits: .......1...)    OPS:  sqr 3 times,    finally sqr 6
            // times
    36UL,   // x = 10 (bits: .....1..1..)    OPS:  sqr 2 times,   sqr 3 times,
            // finally sqr 5 times
    0UL,    // x = 11
    80UL,   // x = 12
    0UL,    // x = 13
...
//  h == highest_one(C) >> 1  == 1UL << (degree(C)-1)
{
  ...
  //#if BITS_PER_LONG == 64
  //    if ( 0==(c & 0xaaaaaaaaaaaaaaaaUL ) )  return 0;  // at least one odd
  //    degree term
  //#else
  //    if ( 0==(c & 0xaaaaaaaaUL ) )  return 0;  // at least one odd degree
  //    term
  //#endif
