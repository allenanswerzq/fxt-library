...
static const double haar2[] = {
    //  +sqrt(0.5),
    //  +sqrt(0.5),
    +0.7071067811865475244008443621048, +0.7071067811865475244008443621048,
    +0.0};
// -------------------------
...
static const double daub4[] = {
    ...
    //  (3.0-sqrt(3.0))/(4.0*sqrt(2.0)),
    //  (1.0-sqrt(3.0))/(4.0*sqrt(2.0)),
    +0.4829629131445341433748716, +0.8365163037378079055752937,
    +0.2241438680420133810259727, -0.1294095225512603811744494,
...
// daub8:
static const double daub8[] = {+3.22231006040514678716159e-02,
...
// daub10:
static const double daub10[] = {+1.95388827352498268e-02,
...
static const double daub12[] = {
    -7.8007083250323804142e-03, +1.7677118642540077410e-03,
    +4.4724901770781384662e-02, -2.1060292512370847991e-02,
    -7.2637522786376583464e-02, +3.3792942172816583271e-01,
    +7.8764114102865099607e-01, +4.9105594192797373304e-01,
    -4.8311742585698054971e-02, -1.1799011114852002540e-01,
    +3.4907120842221625153e-03, +1.5404109327044824299e-02,
...
// test:
static const double test[] = {+0.5, +0.5, -0.5, +0.5,
