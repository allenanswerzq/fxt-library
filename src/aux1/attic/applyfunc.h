...
template <typename Type>
inline void apply_func(Type *f, ulong n, Type (*func)(Type, Type),
                       const Type *g)
...
template <typename Type>
inline void apply_idx_func(Type *f, ulong n, Type (*func)(Type, Type, ulong),
                           const Type *g)
...
template <typename Type>
inline void val2idxvec_func(const Type *f, ulong n, ulong (*func)(Type),
                            ulong *x)
...
template <typename Type>
inline void idxvec2val_func(const ulong *x, ulong n, Type (*func)(ulong),
                            Type *f)
...
template <typename Type>
inline void idx2val_func(Type *f, ulong n, Type (*func)(Type), Type x0 = 0,
                         Type x1 = 1)
