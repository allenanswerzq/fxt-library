...
#if BITS_PER_LONG == 64
  {
    ulong m = 0x00000000ffff0000UL;
    m &= x;
    x ^= m;
    x ^= (m << 16);
  }
  {
    ulong m = 0x0000ff000000ff00UL;
    m &= x;
    x ^= m;
    x ^= (m << 8);
  }
  {
    ulong m = 0x00f000f000f000f0UL;
    m &= x;
    x ^= m;
    x ^= (m << 4);
  }
  {
    ulong m = 0x0c0c0c0c0c0c0c0cUL;
    m &= x;
    x ^= m;
    x ^= (m << 2);
  }
  {
    ulong m = 0x2222222222222222UL;
    m &= x;
    x ^= m;
    x ^= (m << 1);
  }
#else
  {
    ulong m = 0x0000ff00UL;
    m &= x;
    x ^= m;
    x ^= (m << 8);
  }
  {
    ulong m = 0x00f000f0UL;
    m &= x;
    x ^= m;
    x ^= (m << 4);
  }
  {
    ulong m = 0x0c0c0c0cUL;
    m &= x;
    x ^= m;
    x ^= (m << 2);
  }
  {
    ulong m = 0x22222222UL;
    m &= x;
    x ^= m;
    x ^= (m << 1);
  }
...
#if BITS_PER_LONG == 64
  {
    ulong m = 0x2222222222222222UL << 1;
    m &= x;
    x ^= m;
    x ^= (m >> 1);
  }
  {
    ulong m = 0x0c0c0c0c0c0c0c0cUL << 2;
    m &= x;
    x ^= m;
    x ^= (m >> 2);
  }
  {
    ulong m = 0x00f000f000f000f0UL << 4;
    m &= x;
    x ^= m;
    x ^= (m >> 4);
  }
  {
    ulong m = 0x0000ff000000ff00UL << 8;
    m &= x;
    x ^= m;
    x ^= (m >> 8);
  }
  {
    ulong m = 0x00000000ffff0000UL << 16;
    m &= x;
    x ^= m;
    x ^= (m >> 16);
  }
#else
  {
    ulong m = 0x22222222UL << 1;
    m &= x;
    x ^= m;
    x ^= (m << 1);
  }
  {
    ulong m = 0x0c0c0c0cUL << 2;
    m &= x;
    x ^= m;
    x ^= (m << 2);
  }
  {
    ulong m = 0x00f000f0UL << 4;
    m &= x;
    x ^= m;
    x ^= (m << 4);
  }
  {
    ulong m = 0x0000ff00UL << 8;
    m &= x;
    x ^= m;
    x ^= (m << 8);
  }
