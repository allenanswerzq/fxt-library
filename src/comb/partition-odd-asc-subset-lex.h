...
// Subset-lex order.
// Only the two or three last parts at the end are different from the previous
// partition. Loopless algorithm. Cf. OEIS sequence A000009. See Joerg Arndt,
// Subset-lex: did we miss an order?, (2014)
//   http://arxiv.org/abs/1405.6503
{
 public:
  ...
  partition_odd_asc_subset_lex &operator=(
      const partition_odd_asc_subset_lex &) = delete;
