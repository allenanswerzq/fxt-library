...
// Cf. OEIS sequences A040039 and A033485.
{
 public:
  ...
  partition_strongly_decr_desc(const partition_strongly_decr_desc &) = delete;
  partition_strongly_decr_desc &operator=(
      const partition_strongly_decr_desc &) = delete;
 ...
 public:
  ...
  ~partition_strongly_decr_desc() { delete[] a_; }
