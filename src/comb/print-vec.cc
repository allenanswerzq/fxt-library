...
void print_vec_rev(const char *bla, const ulong *x, ulong n,
                   bool dfz /*=false*/)
// Print x[0,..,n-1] as vector in reversed order, n is the number of elements in
// the set. If dfz is true then Dots are printed For Zeros.
{
  if (bla) cout << bla;
