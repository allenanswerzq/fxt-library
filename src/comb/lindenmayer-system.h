...
// Copyright (C) 2017, 2019, 2020 Joerg Arndt
...
class lindenmayer_system : public string_subst
// Lindenmayer-system.
...
// jj_end_autodoc
{
 ...
 public:
  lindenmayer_system(ulong iter, const std::string axiom,
                     const std::vector<std::string> maps, ulong maxrlen = 2048)
 ...
 public:
  ...
  bool change_axiom(const std::string axiom) {
    axiom_str_ = axiom;
    const bool q = string_subst::set_axiom(axiom.c_str(), true);
    return q;
  }
