...
void print_set_as_deltaset(const char *bla, const ulong *f, ulong n, ulong N,
                           const char *c01 = nullptr);
void print_set1_as_deltaset(const char *bla, const ulong *x, ulong n, ulong N,
                            const char *c01 = nullptr);
ulong print_deltaset_as_set(const char *bla, const ulong *x, ulong n,
                            int eq = 0);
ulong print_deltaset_as_set1(const char *bla, const ulong *x, ulong n,
                             int eq = 0);
void print_deltaset(const char *bla, const ulong *x, ulong n,
                    const char *c01 = nullptr);

// comb/print-mset.cc:
ulong print_multi_deltaset_as_set(const char *bla, const ulong *x, ulong n,
                                  bool cq = true);
ulong print_multi_deltaset_as_set_alph(const char *bla, const ulong *x, ulong n,
                                       bool cq = true);
...
void print_setpart(const char *bla, const ulong *f, ulong n, ulong ns,
                   ulong off = 1);
...
void print_mixedradix(const char *bla, const ulong *f, ulong n,
                      bool dfz = false);
