...
// Must have:  n >= k.
{
 public:
  ...
  composition_ex_colex(const composition_ex_colex &) = delete;
  composition_ex_colex &operator=(const composition_ex_colex &) = delete;
 ...
 public:
  ...
  bool OK() const { return is_composition_nz(data(), k_, n_); }
