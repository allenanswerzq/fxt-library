...
// Cf. OEIS sequence A001006.
{
 public:
  ...
  motzkin_step_rgs_lex(const motzkin_step_rgs_lex &) = delete;
  motzkin_step_rgs_lex &operator=(const motzkin_step_rgs_lex &) = delete;
 ...
 public:
  ...
  bool OK() const { return is_motzkin_step_rgs(a_, n_ + 1); }
};
// -------------------------
