...
//   http://arxiv.org/abs/1405.6503
{
 ...
 private:  // have pointer data
  ...
  mixedradix_subset_lexrev &operator=(const mixedradix_subset_lexrev &) =
      delete;

 public:
  explicit mixedradix_subset_lexrev(ulong n, ulong mm,
                                    const ulong *m = nullptr) {
    n_ = n;
    bool z = (n_ == 0);
#ifndef MIXEDRADIX_SUBSET_LEXREV_FIXARRAYS
    a_ = new ulong[n_ + 1 + z];
