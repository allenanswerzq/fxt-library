...
void tree_lev_seq_aux::print_aa(const char *bla, const ulong *a,
                                ulong n) const {
  cout << bla;
  cout << "O";  // root
...
void tree_lev_seq_aux::print_branching_numbers(const char *bla, const ulong *a,
                                               ulong n,
                                               bool dfz /*=true*/) const {
...
void tree_lev_seq_aux::print_base_seq(const char *bla, const ulong *a, ulong n,
                                      bool dfz /*=true*/) const
...
void tree_lev_seq_aux::print_paren_word(const char *bla, const ulong *a,
                                        ulong n,
                                        const char *s /*="()"*/) const {
  cout << bla;
  if (n == 0) return;
...
void tree_lev_seq_aux::print_balanced_composition(const char *bla,
