...
//   http://arxiv.org/abs/1405.6503
{
 public:
  ...
  catalan_step_rgs_subset_lexrev(const catalan_step_rgs_subset_lexrev &) =
      delete;
  catalan_step_rgs_subset_lexrev &operator=(
      const catalan_step_rgs_subset_lexrev &) = delete;
 ...
 public:
  ...
  void print(const char *bla, bool dfz) const { print_vec(bla, a_, n_, dfz); }
  ...
  bool OK() const { return is_catalan_step_rgs(data(), n_); }
};
// -------------------------
