...
// first. Lexicographic order. See OEIS sequences A079500 and A007059.
{
 public:
  ...
  composition_nz_first_max &operator=(const composition_nz_first_max &) =
      delete;
 ...
 public:
  ...
  ~composition_nz_first_max() { delete[] a_; }
