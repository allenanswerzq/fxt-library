...
// Cf. OEIS sequence A001523.
{
 public:
  ...
  composition_nz_weakly_unimodal(const composition_nz_weakly_unimodal &) =
      delete;
  composition_nz_weakly_unimodal &operator=(
      const composition_nz_weakly_unimodal &) = delete;
 ...
 public:
  ...
  ~composition_nz_weakly_unimodal() { delete[] a_; }
 ...
 public:
  ...
  void print(const char *bla) const { print_vec(bla, a_ + 1, m_); }
