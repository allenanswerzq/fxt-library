...
void print_zero_map_rgs_as_zero_dist_rgs(const char *bla, const ulong *a,
                                         ulong n, bool dfz /*=true*/)
...
void print_zero_map_rgs_as_fp_rgs(const char *bla, const ulong *a, ulong n,
                                  bool dfz /*=true*/, bool zb /*=true*/)
...
void print_zero_map_rgs_as_fp_dist_rgs(const char *bla, const ulong *a, ulong n,
                                       bool dfz /*=true*/, bool zb /*=true*/)
...
void print_zero_map_rgs_setpart(const char *bla, const ulong *a, ulong n,
                                bool zb /*=false*/, bool iq /*=false*/)
