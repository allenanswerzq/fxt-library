...
// Loopless generation.
{
 protected:
  ...
  // Internally the empty set is represented with one element pointing to a
  // zero, the method iset_size() hides this (by default) from the user, see
  // there.
  ulong *a_;   // Digits
 ...
 private:  // have pointer data
  ...
  mixedradix_naf_subset_lex &operator=(const mixedradix_naf_subset_lex &) =
      delete;

 public:
  explicit mixedradix_naf_subset_lex(ulong n, ulong mm,
