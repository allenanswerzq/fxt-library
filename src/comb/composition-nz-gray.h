...
//   http://arxiv.org/abs/1405.6503
{
 ...
 protected:
  ...
  bool same_parity(ulong x, ulong y) const { return 0 == ((x ^ y) & 1UL); }
 ...
 public:
  ...
  // Loopless algorithm.
  {
    ...
    ulong z = a_[m_];
    if (z != 1)
      return next_zgt1(same_parity(n_, z));
    else
      return (oddq(n_) ? next_odd_zeq1() : next_even_zeq1());
  }
  ...
  // Loopless algorithm.
  {
    ...
    if (z != 1)
      ...
      return (evenq(n_) ? next_odd_zeq1() : next_even_zeq1());
  }
