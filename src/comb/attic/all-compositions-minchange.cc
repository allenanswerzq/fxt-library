...
void all_compositions_minchange::swap(ulong i1, ulong i2, ulong k) {
  --i2;
  //    jjassert( i2 < b_ );
  for (; i1 < i2; ++i1, --i2) {
    ulong k1 = i1 * k_;
...
//
void all_compositions_minchange::gray(ulong k) {
...
void all_compositions_minchange::init() {
  uchar *p = xx_;
...
void all_compositions_minchange::print() const {
  cout << "   ";
  cout << "x[  ";
