...
//% Integer partitions into distinct parts in lexicographic order, recursive
//algorithm. % Cf. OEIS sequence A000009.
...
int main(int argc, char **argv) {
  ...
  const ulong na = (ulong)floor((sqrt(1 + 8 * (double)n) - 1) /
                                2);  // max number of parts, see A003056
  a = new ulong[na];
  //    cout << " na=" << na << endl;
...
/// make-target2: "1demo DSRC=demo/comb/partition-dist-lex-rec-demo.cc
