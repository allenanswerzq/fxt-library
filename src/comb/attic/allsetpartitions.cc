...
ulong all_set_partitions::bell_table[] = {
    // Bell numbers
    1UL,           // 0
    1UL,           // 1
    2UL,           // 2
...
void all_set_partitions::init(bool xdr, int dr0) {
  p_[0] = -1;   // == { {1} }
...
void  // static
all_set_partitions::cp_append(const signed char *src, signed char *dst, ulong k,
                              ulong a)
// Used by init:
