...
//   http://arxiv.org/abs/1405.6503
{
 public:
  ...
  partition_dist_asc_subset_lex(const partition_dist_asc_subset_lex &) = delete;
  partition_dist_asc_subset_lex &operator=(
      const partition_dist_asc_subset_lex &) = delete;
 ...
 public:
  ...
  ~partition_dist_asc_subset_lex() { delete[] a_; }
