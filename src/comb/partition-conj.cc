...
// Return whether a[] (ma parts) and b[] (mb parts) are mutually conjugate
// partitions. Both a[] and b[] must be weakly ascending lists with the first
// element at index 0.
{
  //    if ( b==nullptr )  { b=a; mb=ma; }
...
// Return whether a[] (ma parts) and b[] (mb parts) are mutually conjugate
// partitions. Both a[] and b[] must be weakly descending lists with the first
// element at index 0.
{
  //    if ( b==nullptr )  { b=a; mb=ma; }
