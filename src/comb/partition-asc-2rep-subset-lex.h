...
// Cf. OEIS sequence A000726.
{
 public:
  ...
  partition_asc_2rep_subset_lex(const partition_asc_2rep_subset_lex &) = delete;
  partition_asc_2rep_subset_lex &operator=(
      const partition_asc_2rep_subset_lex &) = delete;
