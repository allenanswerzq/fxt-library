...
// Copyright (C) 2010, 2011, 2012, 2017, 2018 Joerg Arndt
...
void mod_reset() {
  ...
  if (mod::mtab != nullptr) delete[] mod::mtab;
  //    mod::root_2pow = 0;
  //    mod::root_m2pow = 0;
}
// -------------------------
...
bool mod_initialize(umod_t m, umod_t *primes /*=nullptr*/) {
  ...
  MI_ASSERT(mod::modfact.is_factorization_of(m),
