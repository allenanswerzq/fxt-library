...
bool factorization::make_factorization(umod_t n, const umod_t *f)
// Setup factorization
...
bool factorization::make_factorization(umod_t n)
// Setup factorization
{
  reset();
  prod_ = n;
