...
void fft_complex_auto_convolution(double *fr, double *fi, ulong ldn,
                                  double v = 0.0);
void fft_complex_convolution(double *fr, double *fi, double *gr, double *gi,
...
void matrix_fft_complex_auto_convolution(double *fr, double *fi, ulong nr,
                                         ulong nc, int zp = 0);

// The rest are generated files:

// convolution/cfhtcnvlcore.cc:
void fht_convolution_core(const Complex *x, Complex *y, ulong ldn,
                          double v = 0.0);  // aux
void fht_convolution_revbin_permuted_core(const Complex *x, Complex *y,
...
void fht_auto_convolution_revbin_permuted_core(Complex *x, ulong ldn,
                                               double v = 0.0);  // aux
