...
void fht_negacyclic_convolution(double *restrict f, double *restrict g,
                                ulong ldn);
...
void right_angle_complex_auto_convolution(double *fr, double *fi, ulong ldn,
                                          double v = 0.0);
void weighted_complex_auto_convolution(Complex *f, ulong ldn, double w,
                                       double v = 0.0);
void negacyclic_complex_auto_convolution(Complex *f, ulong ldn, double v = 0.0);
void right_angle_complex_auto_convolution(Complex *f, ulong ldn,
                                          double v = 0.0);
