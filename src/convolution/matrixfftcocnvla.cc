...
//#warning "FYI: using simple algorithm for matrix_fft_auto_convolution(Complex
//*f, ...)"
#else  // USE_OLD_ALGORITHM
//#warning "FYI: using revbin_permute for transpose for
//matrix_fft_auto_convolution(Complex *f, ...)"
#if (USE_SPLRX == 1)
