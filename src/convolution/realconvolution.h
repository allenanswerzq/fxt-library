...
void fht_convolution_core(const double *x, double *y, ulong ldn,
                          double v = 0.0);  // aux
void fht_convolution_revbin_permuted_core(const double *x, double *y, ulong ldn,
                                          double v = 0.0);  // aux

// convolution/fhtcnvlacore.cc:
void fht_auto_convolution_core(double *x, ulong ldn, double v = 0.0);  // aux
void fht_auto_convolution_revbin_permuted_core(double *x, ulong ldn,
                                               double v = 0.0);  // aux
...
void fft_convolution_core1(const double *x, double *y, ulong ldn,
                           double v = 0.0);  // aux
void fft_convolution_core2(const double *x, double *y, ulong ldn,
                           double v = 0.0);  // aux
...
void twodim_fht_convolution_core(const double *f, double *g, ulong nr,
                                 ulong nc);  // aux
