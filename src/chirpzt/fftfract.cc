...
// See: Nussbaumer: "Fast Fourier Transform and Convolution Algorithms", chap.5,
// p.113ff Could use n*k == - n^2/2 - k^2/2 + (k+n)^2/2 instead.
//
...
static inline void make_fft_fract_chirp(double *wr, double *wi, double v,
                                        ulong n, ulong nn)
...
static void ri_multiply(const double *fr, const double *fi, double *gr,
                        double *gi, ulong n)
