...
digraph_paths::digraph_paths(digraph &g) : g_(g), ng_(g_.ng_) {
  rv_ = new ulong[ng_];
  qq_ = new ulong[ng_];
...
bool digraph_paths::path_is_cycle() const
...
ulong digraph_paths::test_lucky_path() const
...
bool digraph_paths::mark(ulong p, ulong &ns) {
...
void digraph_paths::print_turns(bool shortq /*=true*/) const {
  cout << "Path:";
