...
//
// void
// print_twodim(const char *bla, const double *f, ulong r, ulong c, double
// eps/*=0.0*/)
//{
//    cout << endl;
...
void c_print(const char *bla, const Complex *c, long n, double eps /*=0.0*/) {
  cout << endl;
  if (bla) cout << bla << endl;
...
void ri_print(const char *bla, const double *fr, const double *fi, long n,
              double eps /*=0.0*/) {
  cout << endl;
  if (bla) cout << bla << endl;
...
static int print_approx_eq(const double *f, const double *g, ulong n,
...
void approx_eq(const double *f, const double *g, ulong n, const char *bla,
               double eps /*=1e-12*/)
//
// for debugging
//
...
void approx_eq(const Complex *f, const Complex *g, ulong n, const char *bla,
               double eps /*=1e-12*/)
//
// for debugging
//
{
  ...
  cout << " imag: " << endl;
  failq |=
      print_approx_eq((double *)f + 1, (double *)g + 1, n, 2, eps);  // jjcast

  cout << (failq ? " *** !ERROR! *** " : "OK.") << endl;
}
// -------------------------

static bool print_approx_eq(const ulong *f, const ulong *g, ulong n, ulong skip)
//
// for debugging
//
{
